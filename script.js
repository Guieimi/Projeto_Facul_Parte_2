...
function showWorkoutAndDiet() {
    ...
    switch (selectedGoal) {
        case "Hipertrofia":
            workout = `<pre> Plano de treino para hipertrofia:
           ...
           5.Crunch abdominal - 3 séries de 15-20 repetições.</pre>`;
            ...
            diet = `<pre>Dieta para hipertrofia:
            
            1. Consuma Proteína Suficiente:

            A proteína é essencial para o reparo e o crescimento muscular. Consuma fontes de proteína magra, como peito de frango, peixe, carne magra, ovos, laticínios com baixo teor de gordura, tofu e leguminosas.
            
            2. Mantenha um Balanço Calórico Positivo:
            
            Para ganhar massa muscular, você deve consumir mais calorias do que gasta. Isso significa que você precisa estar em um superávit calórico. No entanto, evite exagerar, pois o excesso de gordura corporal pode ocorrer se você consumir muitas calorias além do necessário.
            
            3. Carboidratos Complexos:
            
            Os carboidratos são importantes para fornecer energia durante os treinos e para repor as reservas de glicogênio muscular. Opte por carboidratos complexos, como aveia, arroz integral, batata-doce, quinoa e legumes.
            
            4. Gorduras Saudáveis:
            
            Inclua gorduras saudáveis em sua dieta, como abacate, nozes, sementes, azeite de oliva e peixes ricos em ômega-3 (salmão, sardinha).
            
            5. Coma Refeições Balanceadas:
            
            Planeje refeições que incluam uma combinação de proteína, carboidratos e gorduras saudáveis. Isso ajuda a manter um equilíbrio nutricional.
            
            6. Refeições Pré e Pós-Treino:
            
            Consuma uma refeição ou lanche que inclua proteína e carboidratos antes do treino para fornecer energia. Após o treino, uma refeição ou shake de proteína ajuda na recuperação muscular.
            
            7. Hidratação Adequada:
            
            Beba água suficiente para manter-se hidratado, pois a desidratação pode afetar negativamente o desempenho nos treinos.
            
            8. Suplementos Opcionais:
            
            Suplementos como proteína em pó, creatina, BCAAs (aminoácidos de cadeia ramificada) e glutamina podem ser usados ​para complementar sua dieta, mas eles não substituem alimentos de verdade.
            
            9. Planejamento e Monitoramento:
            
            Mantenha um registro de suas refeições e monitore seu progresso. Isso pode ajudar a ajustar sua dieta conforme necessário.
            
            10. Descanso e Recuperação:
            
            Lembre-se de que a recuperação adequada é tão importante quanto a dieta. Dê ao seu corpo tempo para se recuperar entre os treinos.</pre>`;
            break;


        case "Perda de peso":
            workout = `<pre>Plano de treino para perda de peso:
            ...
            diet = `<pre>Dieta para perda de peso:
           
            - Café da Manhã:

            Opção 1: Omelete de claras de ovos com vegetais (espinafre, tomate, pimentão), uma fatia de abacate e uma porção de aveia com frutas vermelhas.
            ...
            Peito de frango grelhado com uma porção generosa de legumes cozidos no vapor (brócolis, cenoura, couve-flor).
           ...
           6. Considere a possibilidade de trabalhar com um nutricionista ou dietista para desenvolver um plano de alimentação personalizado.</pre>`;
            break;

            case "Saúde":
            workout = `<pre>Plano de treino para manter uma boa saúde:
           
            Objetivo do Plano: Melhorar a saúde geral, aumentar a resistência, a força muscular e a flexibilidade.

            Duração do Plano: Este plano é projetado para ser executado continuamente, com ajustes à medida que você progride.
            
            Frequência: Recomenda-se realizar este treino de 3 a 5 vezes por semana, dependendo da sua disponibilidade e nível de condicionamento físico.
            
            Aquecimento: Comece cada sessão de treinamento com 5-10 minutos de aquecimento cardiovascular leve, como caminhada rápida, bicicleta ergométrica ou pular corda.
            
            Treino de Força: Realize exercícios de treinamento de força para fortalecer os principais grupos musculares. Você pode começar com 2-3 séries de 8-12 repetições para cada exercício.
            ...
            Treino de Cardiovascular: Realize atividades cardiovasculares para melhorar a resistência cardiovascular. Isso pode incluir corrida, bicicleta, natação, esteira ou elíptico. Tente acumular pelo menos 150 minutos de atividade moderada por semana.
            
            Treino de Flexibilidade: Dedique 10-15 minutos a exercícios de alongamento no final de cada treino ou em dias separados. Isso ajudará a melhorar a flexibilidade e reduzir o risco de lesões.
            
            Descanso: Certifique-se de incluir dias de descanso para permitir a recuperação adequada. Se você estiver treinando 5 vezes por semana, por exemplo, faça 2 dias de descanso ativo (como uma caminhada leve) e 2 dias completos de descanso.
            
            Nutrição: Lembre-se de manter uma dieta equilibrada, rica em alimentos nutritivos, e beba bastante água para apoiar seus esforços de treinamento.
            
            Progressão: À medida que você se torna mais forte e mais condicionado, aumente gradualmente a intensidade e o peso dos exercícios. Um personal trainer pode ajudá-lo a criar um plano de progressão adequado.
            
            Monitoramento: Acompanhe seu progresso ao longo do tempo para se manter motivado. Isso pode ser feito registrando suas atividades, pesos e medidas corporais.</pre>`;
                        
            
            diet = `<pre>Dieta para manter a boa saúde:
            
            
            Frutas e Vegetais: Consuma uma variedade de frutas e vegetais diariamente. Eles são ricos em vitaminas, minerais, fibras e antioxidantes. Tente preencher metade do seu prato com frutas e vegetais em cada refeição.

            Grãos Integrais: Opte por grãos integrais em vez de grãos refinados. Isso inclui alimentos como pão integral, arroz integral, massa integral e aveia. Os grãos integrais fornecem fibras e nutrientes essenciais.
            
            Proteínas Magras: Inclua fontes de proteína magra em sua dieta, como peito de frango, peixe, carne magra, ovos, tofu, legumes e feijões. A proteína é importante para a reparação e crescimento dos tecidos.
            
            Laticínios com Baixo Teor de Gordura: Se você consome laticínios, escolha opções com baixo teor de gordura ou alternativas à base de plantas, como leite de amêndoa ou soja.
            
            Gorduras Saudáveis: Opte por gorduras saudáveis, como abacate, azeite de oliva, nozes e sementes. Evite gorduras saturadas e trans, encontradas em alimentos processados e fast-food.
            
            Limitação de Açúcares e Alimentos Processados: Reduza o consumo de açúcares adicionados, refrigerantes, doces e alimentos altamente processados. Eles tendem a ser pobres em nutrientes e ricos em calorias vazias.
            
            Controle de Porções: Mantenha o controle das porções para evitar excessos. Comer em pratos menores pode ajudar a controlar o tamanho das porções.
            
            Hidratação: Beba bastante água ao longo do dia para se manter hidratado. Evite bebidas açucaradas e refrigerantes.
            
            Refeições Balanceadas: Tente equilibrar suas refeições incluindo uma fonte de proteína, vegetais, grãos e uma pequena quantidade de gordura saudável.
            
            Variedade: Uma dieta variada ajuda a garantir que você obtenha todos os nutrientes de que precisa. Experimente novos alimentos e receitas para manter sua alimentação interessante.
            
            Reduza o Sal: Diminua a ingestão de sódio, evitando alimentos excessivamente salgados. Use ervas e especiarias para dar sabor à comida em vez de sal.
            
            Evite o Álcool em Excesso: Se você bebe álcool, faça-o com moderação. Limite a ingestão de álcool a quantidades recomendadas.</pre>`;
                        break;

                        case "Fortalecimento":
                            workout = `<pre>Plano de treino para quem fortalecer os musculos:
            ...
            Dia 7: Descanso</pre>`;
                ...
                diet = `<pre>Dieta para fortalecer os musculo:
            ...
            Outro shake de proteína ou uma refeição rica em proteínas, como frango grelhado com batata-doce e vegetais
            Jantar:
            ...
            Priorize fontes magras de proteína, como peito de frango, peixe, carne magra e produtos lácteos com baixo teor de gordura.
            Inclua uma variedade de vegetais em suas refeições para obter uma ampla gama de nutrientes.
            Coma carboidratos complexos, como aveia, quinoa e arroz integral, para fornecer energia sustentada.
            ...
            Ajuste as porções de acordo com suas necessidades calóricas e metas de composição corporal.</pre>`;
            break;

              case "Condicionamento físico":
               workout = `<pre>Plano de treino para quem quer manter condicionameto fisico:
            ...
            Dia 7: Descanso </pre>`;
                ...
                diet = `<pre>Dieta para Condicionamento Fisico:
                
                
                1. Proteína:

            Inclua fontes de proteína magra em todas as refeições, como frango, peixe, carne magra, ovos, tofu, leguminosas e laticínios com baixo teor de gordura.
            A proteína é essencial para a recuperação muscular e o crescimento.
            
            2. Carboidratos:

            Escolha carboidratos complexos, como grãos integrais, aveia, arroz integral, quinoa e batata-doce.
            Os carboidratos fornecem energia para os treinos e ajudam na recuperação.
            
            3. Gorduras saudáveis:

            Inclua fontes de gorduras saudáveis, como abacate, nozes, sementes, azeite de oliva e peixes ricos em ômega-3 (salmão, sardinha).
            As gorduras saudáveis são importantes para a saúde geral e a função celular.
            
            4. Vegetais e frutas:

            Coma uma variedade de vegetais e frutas coloridos para obter uma ampla gama de nutrientes e antioxidantes.
            Eles são ricos em vitaminas, minerais e fibras, que promovem a saúde e a recuperação.
            
            5. Hidratação:

            Beba água suficiente ao longo do dia para se manter bem hidratado.
            Durante os treinos intensos, considere bebidas esportivas ou água com eletrólitos para repor os nutrientes perdidos.
            
            6. Refeições equilibradas:

            Planeje refeições que incluam proteínas, carboidratos e gorduras em quantidades adequadas.
            ...
            Preste atenção às necessidades individuais de calorias com base no seu nível de atividade e objetivos.
            
            8. Evite alimentos processados e açúcares adicionados:

            Reduza o consumo de alimentos ricos em açúcar, gorduras trans e alimentos processados.
            Opte por lanches saudáveis, como iogurte grego, frutas, nozes e barras de proteína de qualidade.
